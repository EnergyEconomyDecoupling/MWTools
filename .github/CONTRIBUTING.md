...
# Contributing to `MWTools`

This document outlines how to propose a change to the `MWTools` package.
...
* New code should be written in a style that matches the rest of the code in `MWTools`. 
